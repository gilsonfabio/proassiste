...
const NewCidade = () => {
    ...
    async function handleRefreshToken(){
      await api({
          ...
          alert(`Falha no token de cadastro das Cidades`);
          Router.push({
              pathname: '/',        
          })      
      })
      ...
      <form>
        <div className="space-y-12 md:ml-28 md:mr-28">
            <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-2xl font-semibold leading-7 text-gray-900">Informações Dados da Cidade</h2>      
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div className="sm:col-span-4">
                        <label className="block text-sm font-medium leading-6 text-gray-900">Descrição Cidade</label>
                        <div className="mt-2">
                            <input 
                                type="text" 
                                name="first-name" 
