...
const AltCidade = () => {
    ...
    const [idCid, setIdCidade] = useState(router.query.cidId);
    ...
    useEffect(() => {    
        ...
        api({
          ...
          headers: {
            ...
            setCidDescricao(response.data[0].cidDescricao);
        }).catch(function(error) {           
          handleRefreshToken()                 
        })
      ...
      <form>
        <div className="space-y-12 md:ml-28 md:mr-28">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-2xl font-semibold leading-7 text-gray-900">Informações da Cidade</h2>      
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              <label className="block text-sm font-medium leading-6 text-gray-900">Descrição da Cidade</label>
              <div className="mt-2">
                <input 
                  type="text" 
                  name="first-name" 
